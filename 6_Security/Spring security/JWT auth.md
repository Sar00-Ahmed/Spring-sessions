...
> When it should because it is using the design pattern Chain of Command.
> 
...
application.jwt.secretKey=securesecuresecuresecuresecuresecuresecuresecuresecuresecuresecure //preferable have the key set in a vault or env file
