...
> [!definition]
> It bridges the gap between object-oriented programming languages and relational databases by mapping application objects to database tables, allowing developers to interact with data using familiar objects instead of raw SQL queries.
