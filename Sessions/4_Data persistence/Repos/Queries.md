...
#### Use `@Modifying`
*   This tells Spring Data this is not a `SELECT` query.
...
#### Return a Custom Value (DTO Projection)
The most powerful and common way. You define a constructor in your DTO and call it in the JPQL query.
...
By understanding these concepts, you can leverage the full power of `@Query` to handle virtually any data access requirement in your Spring Data JPA application.
#core