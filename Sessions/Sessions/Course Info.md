...
- Implementation team will implement and come with bugs that we try to solve, they will need to upload their work for the others to use.
- Research teams will do the further reading and summarise and explain it. They don’t need to limit themselves to the topics I provide. If you find something that I lacked in explanation or topics that were confusing and wanted to provide better explanations they could do that.
- The teams will switch every session to give a chance to everyone.
# Not covered
